...
function updateDescription(style, layout) {
    ...
    // Use the external layoutStyleDescriptions from style-descriptions.js
    const key = `${style}_${layout}`;
    const description = layoutStyleDescriptions[key] || layoutStyleDescriptions[`${style}_dashboard`];
